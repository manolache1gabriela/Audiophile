                ...
                <div className="navbar-pages">
                    <div className="navbar-menu">
                        <div className="menu">
                            ...
                            }} src="/assets/shared/tablet/icon-hamburger.svg" alt="" />
                        </div>
                        <div className="logo">
                        ...
                        <div className="access-pages">
                            <div className="home-links">
                                ...
                                <NavLink to='/category/headphones' className="home-link">
                                    <p className="sub-title">HEADPHONES</p>
                                </NavLink>
                                <NavLink to='/category/speakers' className="home-link">
                                    <p className="sub-title">SPEAKERS</p>
                                </NavLink>
                                <NavLink to='/category/earphones' className="home-link">
                                    <p className="sub-title">EARPHONES</p>
                                </NavLink>
                            </div>
                        </div>
                        <div className="favorite_cart">
                            ...
                            <img onMouseEnter={() => {
                                ...
                                id="cart-icon" src="/assets/shared/desktop/icon-cart.svg" alt="cart items" />
                        </div>
                    </div>
                </div>
            </section>
            {openModalFavorite && <FavoriteModal openModalFavorite={openModalFavorite} setOpenModalFavorite={setOpenModalFavorite} />}
            {openModalCart && <CartModal openModalCart={openModalCart} setOpenModalCart={setOpenModalCart} />}
            {openModalMenu && <MenuModal openModalMenu={openModalMenu} setOpenModalMenu={setOpenModalMenu} />}
        </div>
    )
}
